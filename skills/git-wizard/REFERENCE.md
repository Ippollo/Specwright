# Git Wizard - Reference Documentation

Extended documentation for the git-wizard skill. Read only when detailed information is needed.

> **Integration Note**: This skill uses the `prompt-engineering` protocols (Chain-of-Thought, Persona).

---

## 1. Smart Commit Protocol (Detailed)
...
## 2. Time Travel Protocol (Recovery) - Detailed
...
## 3. Conflict Resolution Protocol - Detailed
...
## 4. History Cleanup Protocol - Detailed
...
## 5. Branch Manager Protocol - Detailed
